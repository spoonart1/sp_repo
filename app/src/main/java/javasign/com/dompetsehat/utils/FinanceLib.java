...
public final class FinanceLib {
    ...
    /**
     * Future value of an debetAmount given the number of payments, rate, debetAmount
    ...
    /**
     * Present value of an debetAmount given the number of future payments, rate, debetAmount
    ...
    /**
     * calculates the Net Present Value of a principal debetAmount

 ...
 */
@Deprecated
public class Old_OverviewTransactionExpenseFragment extends BaseFragment{
  ...
  public Old_OverviewTransactionExpenseFragment(){
    //keep empty
  }

  public static Old_OverviewTransactionExpenseFragment newInstance(){
    Old_OverviewTransactionExpenseFragment fragment = new Old_OverviewTransactionExpenseFragment();
    return fragment;
  }

  public Old_OverviewTransactionExpenseFragment setTab_name(String tab_name) {
  ...
  private void setData(){
    ...
    if(this.tab_name != null){
      tv_time.setText(getString(R.string.expense)+" "+this.tab_name.toLowerCase());
      presenter.populateOverviewTransaction("DB",this.tab_name);
    }
  }
